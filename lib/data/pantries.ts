...
export const pantries: Pantry[] = [
  ...
  {
    id: '5',
    name_en: 'Iglesia Bautista Betel Food Pantry',
    name_es: 'Despensa de Alimentos Iglesia Bautista Betel',
    address: '2123 Chapel Hill Rd',
    city: 'Durham',
    state: 'NC',
    zip: '27707',
    latitude: 35.9692,
    ...
    hours: [
      ...
      { day: 'wednesday', open: '17:00', close: '19:00' },
    ...
    services: ['food pantry', 'baby food', 'diapers'],
  ...
  {
    id: '7',
    name_en: 'Walltown Neighborhood Ministries',
    name_es: 'Ministerios del Vecindario Walltown',
    address: '1219 Onslow St',
    city: 'Durham',
    state: 'NC',
    zip: '27705',
    latitude: 36.0089,
    ...
    eligibility_en: 'Priority given to Walltown neighborhood residents. Others welcome as capacity allows.',
    eligibility_es: 'Prioridad para residentes del vecindario Walltown. Otros son bienvenidos según la capacidad.',
    services: ['food pantry', 'after school meals'],
    languages_spoken: ['English'],
    walk_in: true,
  ...
  {
    id: '10',
    name_en: 'End Hunger Durham Mobile Pantry',
    name_es: 'Despensa Móvil End Hunger Durham',
    ...
    longitude: -78.8986,
    phone: '(919) 956-2513',
    website: 'https://www.endhungerdurham.org',
    hours: [
      { day: 'monday', open: '00:00', close: '00:00', closed: true },
      { day: 'tuesday', open: '16:00', close: '18:00' },
      { day: 'wednesday', open: '00:00', close: '00:00', closed: true },
      { day: 'thursday', open: '16:00', close: '18:00' },
      { day: 'friday', open: '00:00', close: '00:00', closed: true },
      { day: 'saturday', open: '00:00', close: '00:00', closed: true },
      { day: 'sunday', open: '00:00', close: '00:00', closed: true },
    ],
    eligibility_en: 'Open to all. Check website for weekly location schedule.',
    eligibility_es: 'Abierto a todos. Consulte el sitio web para el horario semanal de ubicaciones.',
    services: ['mobile food distribution', 'fresh produce'],
    languages_spoken: ['English', 'Spanish'],
    walk_in: true,
